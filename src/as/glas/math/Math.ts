...
export namespace _Math {
	...
	export function generateUUID(): string {
        ...
        var uuid = 
            lut[ d0 & 0xf ] + lut[ d0 >> 4 & 0xf ] + 
            lut[ d0 >> 8 & 0xf ] + lut[ d0 >> 12 & 0xf ] +
            lut[ d0 >> 16 & 0xf ] + lut[ d0 >> 20 & 0xf ] +
            lut[ d0 >> 24 & 0xf ] + lut[ d0 >> 28 & 0xf ] 
            + '-' +
            lut[ d1 & 0xf ] + lut[ d1 >> 4 & 0xf ] +
            lut[ d1 >> 8 & 0xf ] + lut[ d1 >> 12 & 0xf ] 
            + '-' + 
            lut[ d1 >> 16 & 0x0f | 0x40 ] + lut[ d1 >> 20 & 0xf ] +
            lut[ d1 >> 16 & 0x0f | 0x40 ] + lut[ d1 >> 28 & 0xf ] 
            + '-' +
            lut[ d2 & 0xf ] + lut[ d2 >> 4 & 0xf ] +
            lut[ d2 >> 8 & 0xf ] + lut[ d2 >> 12 & 0xf ] 
            + '-' + 
            lut[ d2 >> 16 & 0xf ] + lut[ d2 >> 20 & 0xf ] +
            lut[ d2 >> 24 & 0xf ] + lut[ d2 >> 28 & 0xf ] +
            lut[ d3 & 0xf ] + lut[ d3 >> 4 & 0xf ] + 
            lut[ d3 >> 8 & 0xf ] + lut[ d3 >> 12 & 0xf ] +
            lut[ d3 >> 16 & 0xf ] + lut[ d3 >> 20 & 0xf ] +
            lut[ d3 >> 24 & 0xf ] + lut[ d3 >> 28 & 0xf ];
